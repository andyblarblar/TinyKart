...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('tinykart_gazebo')
    ...
    remappings = [('/tf', 'tf'), ('/tf_static', 'tf_static'), ('/cmd_vel', '/nav_vel'), ('/odom', '/tinykart/odom')] #TODO redo 
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value=os.path.join(
                get_package_share_directory('tinykart_gazebo'),
                'config', 'navigation', 'bt_without_spin.xml'),
